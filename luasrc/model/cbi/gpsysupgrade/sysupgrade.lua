...
function check_update()
		...
		updatelogs = luci.sys.exec("echo -n $(curl -fsSL https://mirror.ghproxy.com/https://github.com/" ..Variable1.. "/" ..Variable2.. "/releases/download/" ..Variable3.. "_" ..Variable4.. "/release.txt) | tr -d '\n'")
